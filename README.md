...
[软件主要来源](https://github.com/kiddin9/openwrt-packages/)（为了方便,这里有的我就不会从源仓库获取）
...
|   3  | luci-app-timecontrol |     ```luci-app-timecontrol```                           | 时间控制工具，用于限制特定时间段内的网络访问。  |  [4IceG](https://github.com/4IceG/luci-app-timecontrol)  |      |
